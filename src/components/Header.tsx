...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 w-full bg-[#FAF8F5]/90 backdrop-blur-md border-b border-[#E5E0D8]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-4 grid grid-cols-2 lg:grid-cols-3 items-center">
        <Link
          href="/"
          className="font-serif font-normal text-2xl tracking-tight text-[#1A1A1A]"
        >
          Postill_ua
        </Link>

        <nav className="hidden lg:flex items-center justify-center gap-7 text-sm font-medium text-[#1A1A1A]">
          <Link
            href="/catalog"
